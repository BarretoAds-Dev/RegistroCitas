...
import LogoutButton from '@/2-app-crm/2-Dashboard-PanelGeneral/components/LogoutButton';
import UserProfileButton from '@/2-app-crm/2-Dashboard-PanelGeneral/components/UserProfileButton';
					...
					<div class={`flex items-center gap-2 sm:gap-2.5 mb-4 sm:mb-6 ${isCollapsed ? 'lg:hidden' : ''}`}>
						...
						<div class="flex-1 min-w-0">
							<h1 class="text-sm sm:text-base font-bold text-gray-900 leading-tight">
								Barreto Realtor<span class="text-gray-600">.</span>
							</h1>
						</div>
					</div>
